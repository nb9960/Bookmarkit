...
# A field to define and manage the generic relation using the foreignkey to contenttype, primary key
class Action(models.Model):
    ...
    # Django doesn't create any field in the database for GenericForeignKey fields
